    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Namber = c.String(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        MethodOfPaymandId = c.Int(nullable: false),
                        PaymandDate = c.DateTime(nullable: false),
                ...
                .ForeignKey("dbo.MethodOfPaymands", t => t.MethodOfPaymandId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId)
                .Index(t => t.MethodOfPaymandId)
                .Index(t => t.ClientId)
                .Index(t => t.UserId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Invoices", "MethodOfPaymandId", "dbo.MethodOfPaymands");
            ...
            DropIndex("dbo.Invoices", new[] { "MethodOfPaymandId" });
            ...
            DropTable("dbo.MethodOfPaymands");
